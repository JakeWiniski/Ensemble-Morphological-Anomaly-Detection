...
The code implements multiple anomaly detection algorithms to flag unusual image patterns and structures:
...
1. **CSV Files:**
   ...
   - Anomalies detected by individual methods and the ensemble are saved in `image_analysis_with_ensemble_outliers.csv`.
